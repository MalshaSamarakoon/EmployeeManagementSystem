...
public class RestClient {
    private static final String GET_ALL_EMPLOYEES = "http://localhost:8085/api/employees";
    private static final String GET_EMPLOYEE_BY_ID = "http://localhost:8085/api/employees/{id}";
    private static final String CREATE_EMPLOYEE = "http://localhost:8085/api/employees";
    private static final String UPDATE_EMPLOYEE = "http://localhost:8085/api/employees/{id}";
    private static final String DELETE_EMPLOYEE = "http://localhost:8085/api/employees/{id}";
